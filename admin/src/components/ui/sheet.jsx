  ...
  (
    ...
    <SheetPortal>
      ...
      >
        ...
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-2 text-slate-500 opacity-70 transition hover:bg-slate-100 hover:text-slate-900">
          <X className="h-5 w-5" />
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 border-b px-6 py-5",
      className
    )}
    {...props}
  />
